...
const diceclick = function () {
  if ((player0Score.textContent === 100) | (player1Score.textContent === 100)) {
    ...
    roll.addEventListener('click', resetClick);
  } else if (player0Score.textContent < 100 && player1Score.textContent < 100) {
...
console.log(player0Score.textContent, typeof player0Score.textContent);
